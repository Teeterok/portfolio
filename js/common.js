$(document).ready(function() {
	...
	$(".btn_nav").click(function() {
		...
		if ($(".header-menu__hidden ul").is(":hidden")) {
			$(".header-menu__hidden ul").slideDown(200);
		} else {
			$(".header-menu__hidden ul").slideUp(200);
		}
...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
  ...
  $(".catalog-menu__btn").click(function(event) {
	...
	$(".partners-tabs li a").click(function(event) {
		event.preventDefault();
		$(".partners-tabs li").removeClass('active');
		$(this).parent().addClass('active');
		$(".partners .tab-pane").removeClass("active");
